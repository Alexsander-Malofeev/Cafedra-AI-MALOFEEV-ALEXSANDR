...
def report(
    ...
    problematic_cols = [] #Пробелмные колонки
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"Настройки: top_k={top_k_categories}, порог пропусков={min_missing_share}\n\n")
        ...
        f.write(f"- Есть высокая кардинальность категорий: **{quality_flags['has_high_cardinality_categoricals']}**\n\n")

        if problematic_cols: #Список проблемных колонок
